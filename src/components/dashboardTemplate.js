...
export default function DashboardTemplate() {
    ...
    const userNavigation = [
      { name: "Dashboard", href: "http://localhost:3000/guestDashboard" },
      { name: "Messages", href: "http://localhost:3000/messenger" },
      { name: "Sign out", href: "#" },
    ];
                              ...
                              <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4">
                                <div className="flex h-16 shrink-0 items-center">
                                  {/* <img
                                    ...
                                    alt="Your Company"
                                  /> */}
                                  <h1 className="text-2xl font-sans text-slate-900">powderful.io</h1>
                                </div>
